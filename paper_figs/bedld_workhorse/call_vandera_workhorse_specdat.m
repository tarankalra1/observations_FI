...
%t_end=2000 ;
 for i=nt1:nt2
  if(~isnan(Tr_wh(i)))  
   [bedldx_wh_vspec(i), bedldy(i), Ur(i), R(i), Beta(i),Tc_ini(i),T_c(i),Tt_ini(i),T_t(i),eta(i),...
                                   psi_back(i)]........
 ...
 save('/media/taran/DATADRIVE2/Obs_data/matfiles/vandera_bedld_workhorse_vspec_inithght.mat',....
