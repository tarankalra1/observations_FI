function [bedld_x, bedld_y, Ur, RR, beta,Tc_ini,T_c,Tt_ini,T_t,eta,psi_back]=........
                            vandera_function_workhorse(time, Hs, Td, depth, d50, d90, .....
...
% 
%disp('phase lag parameter fixed to be reduced')
...
if(ratio>1.587)
   ...
   % cff1=(cff*ratio)
     fwi=0.00251*exp(5.21*(cff3)^(-0.19)) ;
    end 
else
    fwi = 0.3;
end
