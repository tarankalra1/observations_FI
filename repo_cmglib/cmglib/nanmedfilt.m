...
% nanmedfilt - Median-filtering.
%  nanmedfilt(theData, theFilterLength, theChunkLength) applies
...
function theResult = nanmdfilt(theData, theFilterLength)

% nanmdfilt -- Median filter.
%  nanmdfilt(theData, theFilterLength) applies a centered
...
if isequal(theData, 'demo')
        ...
        theFilterLength = 3
        theFilteredData = nanmdfilt(theData, theFilterLength)
        return
end
