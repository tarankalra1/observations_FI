...
figure(2)
plot(dn(nt1:nt2),Su_skewness_adv_abs(nt1:nt2),'linewidth',2);
hold on 
plot(dn(nt1:nt2),Su_skewness_ruess(nt1:nt2),'linewidth',2); 
hold on 
%hold on 
...
print -dpng 'pngfiles/Su_skewness_abs.png'  
...
figure(4)
% plot(dn(nt1:nt2),Au_skewness_adv(nt1:nt2),'linewidth',2);
% hold on
plot(dn(nt1:nt2),Au_skewness_ruess(nt1:nt2)*10^8,'linewidth',2);

% plot(Dwave(nt1:nt2),Su_skewness_adv(nt1:nt2),'r.','linewidth',2);
% hold on
% plot(Dwave(nt1:nt2),Su_skewness_ruess(nt1:nt2),'b.','linewidth',2);
% legend('adv','whp')
% xlabel('Dwave')
% ylabel('Su')
% print -dpng 'Dwave_skewness_issue_zoom.png'  

% figure(6)
% plot(Hrmsu(nt1:nt2),Su_skewness_adv(nt1:nt2),'r.','linewidth',2);
...
% xlim([dn(nt1) dn(nt2)]);
% datetick('x',2) % 'keeplimits')
% print -dpng 'Su_skewness_issue_zoom.png'  
